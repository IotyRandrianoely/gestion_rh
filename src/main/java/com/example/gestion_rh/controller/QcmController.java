...
public class QcmController {
    ...
    public String getQuestionsEntretien(
            ...
            @RequestParam(required = true) Integer candidatId,  // required=true pour forcer le paramètre
            @RequestParam(required = true) Integer annonceId,   // required=true pour forcer le paramètre
            Model model) {
        
        if (candidatId == null || annonceId == null) {
            return "redirect:/error";
        }
    ...
    public String submitAnswers(
        ...
        // Sauvegarder le score avec les IDs corrects
